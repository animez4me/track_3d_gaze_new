...
bool triangulate = true; //should be true in the runtime
...
std::string KINECT_CLOUD_TYPE = "/kinect2/sd/points";
...
// Kalman Filter parameters
        ...
        int minInliersKalman = 30; //30;    // Kalman threshold updating
